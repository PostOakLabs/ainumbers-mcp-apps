...
const TOOL_ID = 'art-32-a2a-agent-card-trust-chain-validator';
...
export function compute(pp) {
  ...
  const output_payload = { trust_determination: verdict, pass_count: passCount, fail_count: failCount, warn_count: warnCount, card_schema_ok, signature_block_present, no_scope_escalation, no_expired_links, checks: allChecks };
