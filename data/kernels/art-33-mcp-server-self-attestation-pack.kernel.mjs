...
const TOOL_ID = 'art-33-mcp-server-self-attestation-pack';
...
export function compute(pp) {
  ...
  const output_payload = { composite_grade, composite_score, per_domain_scores, pass_count: passCount, warn_count: warnCount, fail_count: failCount, remediation };
