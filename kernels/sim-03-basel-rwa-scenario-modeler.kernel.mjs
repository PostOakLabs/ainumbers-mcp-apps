...
function erf(x) {
  ...
  const p = 1 - t * (0.254829592 + t * (-0.284496736 + t * (1.421413741 + t * (-1.453152027 + t * 1.061405429)))) * det.exp(-x * x);
  return x >= 0 ? p : -p;
}
...
function irbK(pd, lgd, m = 2.5) {
  ...
  const r = 0.12 * (1 - det.exp(-50 * pdC)) / (1 - det.exp(-50))
          + 0.24 * (1 - (1 - det.exp(-50 * pdC)) / (1 - det.exp(-50)));
